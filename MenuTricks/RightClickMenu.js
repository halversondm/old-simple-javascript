...
m1[3]=new Array("Freewarejava"+arrow2SubMenu,"icons/pelle.gif",11); //denote sub menu (using "arrow2SubMenu")
...
m1[6]=new Array("Technology Sites"+arrow2SubMenu,"icons/pelle.gif",12); //denote sub menu (using "arrow2SubMenu")
...
m11[2]=new Array("Tutorials"+arrow2SubMenu,"icons/pelle.gif",21);
